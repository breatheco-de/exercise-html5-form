...
1. Por favor, usa tus habilidades HTML5/CSS y Bootstrap para replicar [este formulario ¡exacto!, incluyedo los márgenes y colores](https://github.com/breatheco-de/html5-form/blob/master/preview.png?raw=true).
